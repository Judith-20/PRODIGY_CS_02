...
# entry1 = Text(root, height=1, width=10, font=("Arial", 12), relief=GROOVE, bd=2)
# entry1.place(x=120, y=60)

# label1 = Label(root, text="Enter Key:", bg="#f0f0f0", font=("Arial", 12))
...
# # File path label already created above
